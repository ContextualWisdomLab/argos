...
function RowView({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        "w-full h-full text-left flex items-center gap-3 py-2 border-b border-border/60 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-inset",
