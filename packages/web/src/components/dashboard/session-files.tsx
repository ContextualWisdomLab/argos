    ...
    <div className="flex flex-wrap items-center gap-2 text-xs">
      {modifiedCount > 0 && (
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-full bg-success/15 px-2.5 py-1 text-success hover:bg-success/25 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-success/50 focus-visible:ring-offset-1 focus-visible:ring-offset-background"
        >
      ...
      {readCount > 0 && (
        <button
          type="button"
          onClick={onOpenFilesTab}
          className="inline-flex items-center gap-1.5 rounded-full bg-muted px-2.5 py-1 text-muted-foreground hover:bg-muted/70 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1 focus-visible:ring-offset-background"
        >
...
function FileRow({ entry, unit, onJump, tone }: FileRowProps) {
  ...
  return (
    <button
      ...
      className="group w-full text-left flex items-center gap-3 px-3 py-2 rounded-md hover:bg-muted/50 transition-colors focus-visible:outline-none focus-visible:bg-muted/50 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-inset"
    >
