...
export function EventList({
  ...
  // ⚡ Bolt Optimization: Parse the date string into a numeric timestamp once
  // and memoize it outside the virtualized list row-render loop.
  // This avoids O(visible_items) date parsing operations on every scroll/render.
