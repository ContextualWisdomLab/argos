        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="text-sm text-destructive hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring rounded-sm px-1"
        ...
        <div className="space-y-3">
          <div className="space-y-1">
            ...
            <p className="text-sm text-muted-foreground">
              아래 프롬프트를 복사해 새로 추적할 프로젝트 폴더의 Claude Code ·
              Codex 세션에 붙여넣으면, Argos가 조직·프로젝트·hook 설치까지
              자동으로 끝냅니다.
            </p>
          </div>
          ...
          <p className="text-xs text-muted-foreground">
            이미 .argos/project.json 이 커밋된 저장소에 합류하는 팀원은 token
            없이 repo 루트에서 <code className="text-foreground">argos</code> 만
            실행하면 팀에 합류합니다.
          </p>
        </div>
