...
function buildChartData(
  ...
  // [Bolt: Performance Optimization] Use a Schwartzian transform (decorate-sort)
  // to avoid O(N log N) + O(N) repeated Date.parse() calls. The cached parsedTimestamp
  // is passed down the pipeline for the while loop condition without prematurely undecorating.
