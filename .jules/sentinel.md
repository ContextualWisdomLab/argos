...
**Vulnerability:** When exporting CSV, fields starting with `=`, `+`, `-`, `@`, `	`, or `` were not escaped which led to Spreadsheet Macro Injection vulnerabilities when the exported CSV file is opened in tools like Excel.
