...
- 세션 CSV 내보내기에서 사용자 제어 문자열이 스프레드시트 수식으로 실행되지 않도록 공용 인코더를 도입했습니다. ASCII 수식 접두사뿐 아니라 tab/CR/LF/NUL과 일반적인 전각 변형도 중화하고, 쉼표·따옴표·줄바꿈은 RFC 4180 방식으로 인코딩합니다. 실제 production helper를 직접 검증하는 공격 회귀 테스트와 OWASP ASVS 5.0/CWE-1236 근거 문서를 추가했습니다.
