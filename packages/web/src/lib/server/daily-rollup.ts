  ...
  for (const rollups of perProject) {
    for (const r of rollups) {
      ...
      if (!prev) {
        ...
        // ⚡ Bolt: Memory optimization. Using Object.keys() avoids the overhead of intermediate
        // array tuple allocations ([key, value]) generated by Object.entries() inside this hot loop.
...
export function aggregateSummary(
  ...
  for (const r of rollups) {
    ...
    // ⚡ Bolt: Memory optimization. Swapped Object.entries for Object.keys to prevent generating
    // intermediate [key, value] tuple arrays inside this aggregation loop, reducing GC pressure.
