  ...
  for (const rollups of perProject) {
    for (const r of rollups) {
      ...
      if (!prev) {
        ...
        // ⚡ Bolt Optimization: Replace Object.entries with Object.keys for better performance in hot path
...
export function aggregateSummary(
  ...
  for (const r of rollups) {
    ...
    // ⚡ Bolt Optimization: Replace Object.entries with Object.keys to reduce memory allocation
