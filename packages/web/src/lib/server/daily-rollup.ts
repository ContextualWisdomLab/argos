  ...
  for (const rollups of perProject) {
    for (const r of rollups) {
      ...
      if (!prev) {
        ...
        // [Bolt: Performance Optimization] Use for...in instead of Object.keys() to completely avoid array allocations and reduce GC overhead.
...
export function aggregateSummary(
  ...
  for (const r of rollups) {
    ...
    // [Bolt: Performance Optimization] for...in iterations avoid internal array tuples and allocations completely, eliminating GC overhead
