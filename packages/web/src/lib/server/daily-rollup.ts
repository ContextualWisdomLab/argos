  ...
  for (const rollups of perProject) {
    for (const r of rollups) {
      ...
      if (!prev) {
        ...
        // [Bolt: Performance Optimization] Use for...in with Object.hasOwn() instead of Object.keys() in hot paths.
...
export function aggregateSummary(
  ...
  for (const r of rollups) {
    ...
    // [Bolt: Performance Optimization] for...in loops with Object.hasOwn() completely avoid array allocations for keys, heavily reducing heap thrashing
