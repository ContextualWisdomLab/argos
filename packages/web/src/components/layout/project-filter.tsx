...
export function ProjectFilter() {
  ...
  return (
    <Select value={selectValue} onValueChange={handleChange}>
      <SelectTrigger aria-label="Select project" className="flex h-9 min-w-40 items-center gap-2 rounded-lg border-0 bg-card px-2.5 text-sm text-foreground ring-1 ring-foreground/10 transition-colors hover:bg-card-elevated dark:bg-card dark:hover:bg-card-elevated">
