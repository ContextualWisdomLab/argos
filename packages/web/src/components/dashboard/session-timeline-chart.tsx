...
function buildChartData(
  ...
  // [Bolt: Performance Optimization] O(N) pre-parse dates via Schwartzian transform to avoid O(N log N) Date.parse calls in sort.
  // The parsed timestamp is preserved for the subsequent mapping pass to eliminate redundant parsing.
  const decoratedUsage = usageTimeline
