...
export function EventList({
  ...
  // ⚡ Bolt: Parse the session start date once at the component level
  // to avoid redundant Date object allocations and parsing overhead
  // inside the virtualized list row renderers.
