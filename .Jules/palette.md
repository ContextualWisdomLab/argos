...
## 2025-02-28 - 짧은 축약어 UI 요소의 스크린 리더 접근성 개선
**Learning:** 날짜 범위 선택기(`DateRangePicker`)의 프리셋 버튼처럼 텍스트가 극도로 축약된 경우("7d", "30d" 등), 스크린 리더 사용자가 그 의미를 명확히 이해하기 어려울 수 있습니다.
**Action:** UI에 짧은 축약어나 모호한 라벨이 사용된 상호작용 요소에는 반드시 명확한 의도를 설명하는 `aria-label`(예: `Select past 7 days`)을 제공하여 스크린 리더 사용자도 직관적으로 기능을 이해할 수 있도록 보완해야 합니다.
