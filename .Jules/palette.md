...
## 2024-09-02 - 비동기 작업 버튼의 로딩 상태 시각화
**Learning:** 사용자는 로그인, 가입과 같은 비동기 폼을 제출했을 때 텍스트만 바뀌면 명확한 시각적 피드백이 부족하다고 느낄 수 있음.
**Action:** 앞으로 비동기 작업 제출 버튼에는 텍스트 변경 외에도 회전하는 로딩 아이콘(Loader2 등)을 추가하여 명확한 진행 상태를 보여주도록 함.
