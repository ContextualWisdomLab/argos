...
## 2026-09-21
### 🎨 UX 및 접근성 개선
* 장식용 Chevron 아이콘에 `aria-hidden="true"` 속성을 추가하여 스크린 리더 환경의 접근성을 향상시켰습니다. (Select, Pagination, EventList, WeekNavigator, ContextSection 컴포넌트 적용)
* `Select` 컴포넌트의 접근성 및 스크롤 화살표에 대한 테스트를 보강했습니다.
