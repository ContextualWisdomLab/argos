...
Current review: [argos#651](https://github.com/ContextualWisdomLab/argos/pull/651)  
...
| Accessibility | Decorative SVG is `aria-hidden`; browser/AT reading order and contrast not captured | Partial |
