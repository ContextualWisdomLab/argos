...
function buildChartData(
  ...
  // ⚡ Bolt Optimization:
  // Use Schwartzian transform (map-sort-map) to avoid repeated Date.parse() overhead.
  // Reduces Date.parse calls from O(N log N) to O(N), significantly speeding up large timelines.
