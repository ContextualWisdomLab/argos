...
export function EventList({
  ...
  // ⚡ Bolt: Parse the start date once at the parent level to prevent
  // repeated O(V) Date instantiation and parsing in the per-row renderers
  // during virtual list scrolling.
