...
## 2025-02-23 - Week Navigator 아이콘 접근성 개선
**Learning:** 이전/다음 버튼 등 시각적으로만 의미를 갖는 `<ChevronLeft>`, `<ChevronRight>` 아이콘이 스크린 리더 접근성 트리에 불필요하게 노출되어 사용성을 해칠 수 있음을 확인했습니다.
**Action:** 장식용 시각적 아이콘에는 항상 `aria-hidden="true"` 속성을 추가하여 접근성 이름을 깨끗하게 유지해야 합니다.
