 ...
 *
 * Local copies are sorted in O(N log N + M log M). Each usage timestamp is parsed
 * once into its sort key, and the forward cursor consumes every tool event once.
 */
