...
- Select, Pagination, WeekNavigator, ContextSection, EventList의 장식용 Chevron을 접근성 트리에서 숨기되 부모 control의 이름·expanded/page-change 동작을 유지하며, reusable component 회귀 테스트로 해당 경계를 고정했습니다.
