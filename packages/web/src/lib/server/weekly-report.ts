...
export async function getWeeklyReport(
  ...
  // 최적화 방법: 단일 for...of 루프와 for...in 루프를 결합하여 중간 배열 할당(Object.keys)을 완전히 제거하고 GC 오버헤드를 대폭 줄였습니다.
  // 기대 효과: `thisWeekRollups`의 크기가 클 경우, 불필요한 배열 생성 오버헤드를 완전히 피하고 성능을 극대화합니다.
